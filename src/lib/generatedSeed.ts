...
export const seedWineries: Winery[] = [
  {
    ...
    "region": "Stefan Voda",
    "city": "Stefan Voda",
    "description": "Небольшое семейное хозяйство в зоне Штефан-Водэ. Специализируется на сортовых красных — Каберне и Мерло баррикной выдержки. Вина отличаются плотной структурой и характерным терруаром юго-востока Молдовы.",
    "priceLevel": "$$",
    "rating": 4.3,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Puhoi",
    "description": "Семейная винодельня с более чем 20-летней историей в регионе Кодру. Широкий ассортимент от лёгких белых до премиальных красных купажей. Известны линейкой Exclusiv и популярными гастрономическими этикетками.",
    "priceLevel": "$$",
    "rating": 4.5,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Stefan Voda",
    "city": "Bascalia",
    "description": "Расположена в Басарабяске на юге Молдовы. Один из крупнейших экспортёров страны, производящий как доступные, так и резервные вина. Сильная линейка автохтонных сортов — Фетяска Нягрэ и Рарэ Нягрэ.",
    "priceLevel": "$$",
    "rating": 4.4,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Calarasi",
    "description": "Один из самых узнаваемых молдавских брендов на международном рынке. Линейка Winemaker's Way сочетает современный стиль и доступную цену. Особое внимание уделяется Совиньон Блан и розовым винам.",
    "priceLevel": "$$",
    "rating": 4.2,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Mereni",
    "description": "Бутиковое хозяйство с акцентом на минимальное вмешательство в виноградник. Вина отражают холмистый рельеф Кодру — элегантные, с выраженной кислотностью. Фирменный стиль — свежие белые и деликатные пино нуар.",
    "priceLevel": "$$$",
    "rating": 4.5,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Bulboaca",
    "description": "Живописный замок-винодельня в Булбоаке, основанный в XIX веке и полностью восстановленный в 2010-х. Одно из главных винных направлений для туристов в Молдове. Производит изысканные вина с международными наградами.",
    "priceLevel": "$$$",
    "rating": 4.8,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Cojusna",
    "description": "Хозяйство с историей более 200 лет в самом сердце Кодру. Сочетает традиции молдавского виноделия с современными технологиями. Отличается разнообразием стилей — от классических бордосских купажей до свежих автохтонных сортов.",
    "priceLevel": "$$",
    "rating": 4.3,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Stefan Voda",
    "city": "Purcari",
    "description": "Легендарная винодельня 1827 года — старейший и наиболее известный молдавский бренд в мире. Знаменитый Негру де Пуркарь подавался к столу британской королевской семьи. Флагман молдавского виноделия с постоянным присутствием на ведущих мировых выставках.",
    "priceLevel": "$$$",
    "rating": 4.9,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Orhei",
    "description": "Один из крупнейших производителей страны с собственными виноградниками в нескольких регионах. Широкая линейка от эконом до Individo — коллекционных вин ограниченного тиража. Обладатель сотен медалей международных конкурсов.",
    "priceLevel": "$$",
    "rating": 4.7,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Cricova",
    "description": "Национальная гордость Молдовы — подземный город-винодельня с 120 км тоннелей в известняковых пещерах. Здесь хранились личные коллекции Германа Геринга и Юрия Гагарина. Мировой эталон игристых вин по классическому методу шампанизации.",
    "priceLevel": "$$",
    "rating": 4.8,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Stefan Voda",
    "city": "Crocmaz",
    "description": "Молодое авторское хозяйство в Крокмазе, ставящее во главу угла чистоту выражения террувара. Небольшие партии вин с акцентом на автохтонные молдавские сорта. Любимец критиков за нестандартный подход и смелые купажи.",
    "priceLevel": "$$$",
    "rating": 4.7,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "city": "Tigheci",
    "description": "Современная винодельня в регионе Валул луй Траян на юге страны. Инвестирует в высокие технологии производства при сохранении молдавского характера. Линейка 3670 — одна из самых узнаваемых в среднем ценовом сегменте.",
    "priceLevel": "$$$",
    "rating": 4.8,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Stefan Voda",
    "city": "Tudora",
    "description": "Небольшое хозяйство в Тудоре с фокусом на крепких красных и выдержанных купажах. Производит вина с отчётливым южным характером — насыщенные, с тёплыми нотами спелых ягод и пряностей.",
    "priceLevel": "$$",
    "rating": 4.3,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Ialoveni",
    "description": "Обладатель рекорда Гиннесса — крупнейший винный погреб в мире с 2 млн бутылок в подземных тоннелях длиной 200 км. Специализируется на длительной выдержке красных вин. Прогулка по тоннелям на автомобиле — особый туристический опыт.",
    "priceLevel": "$$",
    "rating": 4.6,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Codru",
    "city": "Cricova",
    "description": "Одна из старейших современных виноделен Молдовы, основанная в 1990-е. Широкая дистрибуция внутри страны и экспорт в Европу и СНГ. Название «Рэдэчинь» означает «корни» — отсылка к глубокой связи с молдавской виноградной традицией.",
    "priceLevel": "$$",
    "rating": 4.5,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Valul lui Traian",
    "city": "Taraclia",
    "description": "Хозяйство из болгарскоязычного района Тараклия на крайнем юге страны. Самый тёплый и солнечный климат Молдовы даёт вина с высокой концентрацией и мягкими танинами. Уникальный терруар с болгарскими виноградарскими традициями.",
    "priceLevel": "$$",
    "rating": 4.2,
    "liked": false,
    "createdAt": now,
  ...
  },
  {
    ...
    "region": "Valul lui Traian",
    "city": "Taraclia",
    "description": "Семейная винодельня в Леове у реки Прут — «Винарня из долины». Гордится экологически чистым подходом и работой с местными сортами. Камерное производство позволяет уделять внимание каждой партии вина.",
    "priceLevel": "$$",
    "rating": 4.4,
    "liked": false,
    "createdAt": now,
